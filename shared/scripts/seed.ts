  ...
  await Promise.all([
    ...
    prisma.warning.create({
      data: {
        ...
        loggedBy: staffMember.discordId,
        isActive: true,
        evidenceUrls: ['https://example.com/evidence2.png', 'https://example.com/evidence3.png'],
      },
    }),
    prisma.warning.create({
      data: {
  ...
  await Promise.all([
    prisma.moderationAction.create({
      data: {
        ...
        when: new Date('2024-11-01'),
        isActive: true,
        evidenceUrls: ['https://example.com/mod-evidence1.png'],
      },
    }),
    prisma.moderationAction.create({
      data: {
    ...
    prisma.moderationAction.create({
      data: {
        ...
        isActive: false,
        evidenceUrls: ['https://example.com/mod-evidence2.png'],
      },
    }),
    prisma.moderationAction.create({
      data: {
