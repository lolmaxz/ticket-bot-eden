    ...
    <div className="rounded-lg bg-white dark:bg-gray-800 p-4 shadow">
      ...
      <div className="lg:hidden">
        <button
          ...
          className="flex w-full items-center justify-between rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
          <div className="flex items-center space-x-2">
            <Filter className="h-4 w-4" />
            <span>{isOpen ? 'Hide Filters' : 'Add Filter'}</span>
            {hasActiveFilters && (
              <span className="ml-2 rounded-full bg-blue-100 dark:bg-blue-900 px-2 py-0.5 text-xs text-blue-800 dark:text-blue-200">
                {selectedTypes.length + (localFilters.assignedStaffId ? 1 : 0)}
              </span>
            )}
          </div>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 flex gap-2">
                <input
                  ...
                  maxLength={25}
                  className="flex-1 rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
                <button
                  type="button"
                  onClick={async () => {
                  ...
                  className="lg:hidden rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600"
            ...
            {hasActiveFilters && (
              <button
                ...
                className="w-full rounded-lg border border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900 px-4 py-2 text-sm font-medium text-red-700 dark:text-red-200 hover:bg-red-100 dark:hover:bg-red-800"
              >
                Clear All Filters
              </button>
            )}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                placeholder="Staff Discord ID"
                maxLength={25}
                className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Limit</label>
